...
class ClientForm(forms.ModelForm):
    class Meta:
        model = Client
        fields = ['clientName', 'addressLine1', 'province', 'phoneNumber', 'emailAddress', 'taxNumber', 'contract_length', 'contract_start', 'contract_end', 'contract_renewal']
...
class ProductForm(forms.ModelForm):
    class Meta:
        model = Product
        fields = ['apt_type', 'description', 'price', 'currency', 'invoice']
...
class SettingsForm(forms.ModelForm):
    class Meta:
        model = Settings
        fields = ['clientName', 'addressLine1', 'province', 'phoneNumber', 'emailAddress', 'taxNumber']
